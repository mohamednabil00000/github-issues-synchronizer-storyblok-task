...
group :test do
  # VCR records HTTP interactions and replays them during test runs, allowing you to test your code without
  # making actual HTTP requests.
  gem "vcr"
  # WebMock allows you to stub HTTP requests and set expectations on them, making it easier to test code
